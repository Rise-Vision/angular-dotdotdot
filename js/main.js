(function () {
  ...
  app.controller('dotdotdotDemoController', ['$scope',
    function ($scope) {
      ...
      $scope.editableParagraph =
        'Their disproportionately long limbs and long prehensile tails make them one of the largest New World monkeys and gives rise to their common name. Spider monkeys live in the upper layers of the rainforest, and forage in the high canopy, from 25 to 30 m (82 to 98 ft).[2] They primarily eat fruits, but will also occasionally consume leaves, flowers, and insects.[2] Due to their large size, spider monkeys require large tracts of moist evergreen forests, and prefer undisturbed primary rainforest.[2] They are social animals and live in bands of up to 35 individuals but will split up to forage during the day.[3]'
    }
  ]);
